...
class Weibo:
    cookie = {"_T_WM":"c00447ce67b351e98920b78b94baa8c8",
              "SCF":"ArjSbAY0_kmw5aKSMhUCfBK0dtaiuAYY8wGc4OedU_MrHH7CPNQasZLyxrYXOHbm8m8LKIUJWHVh2GmD5uRy7BA.",
              "SUBP":"0033WrSXqPxfM725Ws9jqgMF55529P9D9WWAs4GzvsP3LE1ZTQZ6hGwB5JpX5KzhUgL.Foq7Shnpe05ESoB2dJLoIp7LxKML1KBLBKnLxKqL1hnLBoMcehBReKe7eoqX",
              "TMPTOKEN":"VMBUYT3qTo2uhwczyL5mP7E4NusxI2Mx12xPAKV4XVcqA09i2jpMLy6TAsuyetx5",
              "SUB":"_2A25xVGepDeRhGedJ7FMV8CvKzDiIHXVStwnhrDV6PUJbkdANLRb5kW1NUaENo0eJDrLvXdlCf-QoDW3SXjsd5hwj",
              "SUHB":"0N2kN24B11U-Dt","SSOLoginState":"1548752889"}  # 将your cookie替换成自己的cookie

    # Weibo类初始化
    def __init__(self, user_id, filter=0):
        self.user_id = 3937348351  # 用户id，即需要我们输入的数字，如昵称为“Dear-迪丽热巴”的id为1669879400
